...
This module defines the Game entity with its relationships and validation logic.
"""
from . import db
...
class Game(BaseModel):
    ...
    def to_dict(self):
        ...
        Returns:
            dict: Dictionary containing game data including publisher and category info
        """
        return {
            'id': self.id,
            'title': self.title,
